...
"""autogenerated by genpy from action_learn/AddIntActionResult.msg. Do not edit."""
import codecs
import sys
...
class AddIntActionResult(genpy.Message):
  _md5sum = "3d669e3a63aa986c667ea7b0f46ce85e"
  _type = "action_learn/AddIntActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_learn/AddIntResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AddIntActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = action_learn.msg.AddIntResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_learn.msg.AddIntResult()
